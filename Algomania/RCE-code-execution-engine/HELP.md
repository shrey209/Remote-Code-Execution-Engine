...
* The original package name 'com.Algomania.RCE-code-execution-engine' is invalid and this project uses 'com.Algomania.RCE_code_execution_engine' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.2.6/reference/htmlsingle/index.html#messaging.kafka)
